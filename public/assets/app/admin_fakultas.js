            ...
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="col-4 form-group">
                        ...
                        <input type="text" id="password" class="form-control" autocomplete="one-time-code">
                    </div>
                    <div class="col-4 form-group">
                        <label for="password_confirm">Konfirmasi Password <i class="text-danger">*</i></label>
                        <input type="text" id="password_confirm" class="form-control" autocomplete="one-time-code">
                    </div>
                    <div class="col-4 form-group">
