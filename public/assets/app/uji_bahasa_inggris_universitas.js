...
function showData() {
    table = $("#datatable").DataTable({
        processing: true,
        serverSide: true,
        ajax: "/api/bahasa-inggris/universitas/data",
        autoWidth: false,
        columnDefs: [
            {
                targets: -1,
        ...
        columns: [
            ...
            {
                data: "listening_universitas",
                name: "listening_universitas",
                orderable: true,
                searchable: true,
            },
            {
                data: "speaking_universitas",
                name: "speaking_universitas",
                orderable: true,
                searchable: true,
            },
            {
                data: "writing_universitas",
                name: "writing_universitas",
                orderable: true,
                searchable: true,
            },
            {
    ...
    $.ajax({
        ...
        success: function (response) {
            const {
                periode,
                id_mahasiswa,
                listening_universitas,
                speaking_universitas,
                writing_universitas,
            } = response.data;
            const modalHeader = "Uji Bahasa Inggris";
            const modalBody = `
                <form class="form form-horizontal">
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-4 form-group">
                                <label for="listening_universitas">Listening <i class="text-danger">*</i></label>
                                <input type="number" step="0.01" id="listening_universitas" value="${listening_universitas}" class="form-control">
                            </div>
                            <div class="col-4 form-group">
                                <label for="speaking_universitas">Speaking  <i class="text-danger">*</i></label>
                                <input type="number" step="0.01" id="speaking_universitas" value="${speaking_universitas}" class="form-control">
                            </div>
                            <div class="col-4 form-group">
                                <label for="writing_universitas">Writing  <i class="text-danger">*</i></label>
                                <input type="number" step="0.01" id="writing_universitas" value="${writing_universitas}" class="form-control">
                            </div>
                        </div>
                    </div>
                </form>
...
function update(id) {
    const periode = $("#periode").val();
    const id_mahasiswa = $("#id_mahasiswa").val();
    const listening_universitas = $("#listening_universitas").val();
    const speaking_universitas = $("#speaking_universitas").val();
    const writing_universitas = $("#writing_universitas").val();
